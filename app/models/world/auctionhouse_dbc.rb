...
# == Schema Information
#
# Table name: auctionhouse_dbc
#
#  ConsignmentRate :integer          default(0), not null
#  DepositRate     :integer          default(0), not null
...
#
module World
  class AuctionhouseDbc < WorldApplicationRecord
    self.table_name = 'auctionhouse_dbc'
    self.primary_key = 'ID'
  end
end
