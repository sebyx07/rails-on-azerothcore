...
#  TotemCategoryMask :integer          default(0), not null
#  TotemCategoryType :integer          default(0), not null
#
module World
  class TotemcategoryDbc < WorldApplicationRecord
    self.table_name = 'totemcategory_dbc'
    self.primary_key = 'ID'
  end
end
